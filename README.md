...
[![Build Status](https://travis-ci.org/yuda-lyu/w-gis.svg?branch=master)](https://travis-ci.org/yuda-lyu/w-gis) 
...
```alias
<script src="https://cdn.jsdelivr.net/npm/w-gis@1.0.3/dist/w-gis.umd.js"></script>
