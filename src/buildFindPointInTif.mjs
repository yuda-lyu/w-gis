 ...
 *
 * Unit Test: {@link https://github.com/yuda-lyu/w-gis/blob/master/test/buildFindPointInTif.test.mjs Github}
 * @memberOf w-gis
 ...
 * import buildFindPointInTif from 'wsemi/src/buildFindPointInTif.mjs'
 *
 * let p
 * let r
 *
