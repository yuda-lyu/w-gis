...
function main() {
    ...
    //url
    let url = `https://cdn.jsdelivr.net/npm/w-gis@${pks.version}/dist/w-gis.umd.js`
    let urlww = `https://cdn.jsdelivr.net/npm/w-gis@${pks.version}/dist/w-gis.wk.umd.js`
